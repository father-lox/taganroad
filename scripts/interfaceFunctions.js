...
//ФИЛЬТР
    function filter(sectionID, type, classShowItem) {
        document.querySelectorAll("#" + sectionID + " ."+ classShowItem).forEach(function(route){
            if (route.getAttribute("data-select-type") === type || type === "all")
            {
                route.style.display = "block";
            }
            else if (route.getAttribute("data-select-type") !== type)
            {
    ...
    document.querySelector("#popular-place select").addEventListener("change", function(e) {
        filter("popular-place", e.currentTarget.value, "place-item");
    });
    document.querySelector("#transport select").addEventListener("change", function(e) {
        filter("transport", e.currentTarget.value, "transport-item");
    });
    document.querySelector("#about-transport select").addEventListener("change", function(e) {
        filter("about-transport", e.currentTarget.value, "transport-item");
    });
